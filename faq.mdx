...
Yes. Docent has a REST API that lets AI agents and bots trade programmatically on Hyperliquid and Polymarket. Each API account gets its own non-custodial wallet. See the [API for agents](/api-for-agents) page for details or jump straight to the [API quickstart](/api-reference/quickstart).
