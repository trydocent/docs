...
Hyperliquid and Polymarket are set up automatically. Poll until both venues are ready.
...
{
  "agentId": "jg7h0r7m7j6q6y4m2jv1v67jv17m9h3k",
  "walletId": "ks7s7l8h4h7k2m6n1q4c8w9x0z3r5t1y",
  "walletAddress": "0x1234...abcd",
  "name": "my-trading-bot",
...
Send USDC to your `walletAddress` on Arbitrum or Base. Docent uses OneBalance to move funds between venues, so you do not need to bridge manually before you trade.
